...
export default function RandomNumber() {
  const breadcrumbs = getBreadcrumbsForTool('random-number');
  ...
  return (
    <PageTransition className="page-medium">
      <SEO
        title="Free Random Number Generator" description="Generate single or multiple random numbers within any custom range online for free." path="/random-number" faqSchema={randomNumberFAQ} 
